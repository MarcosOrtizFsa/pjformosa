...
class _Abm {
	...
	public function agregar_modificar(	$id_system_01,
										$id_system_03,
										$sesion_system_06,	
										$rela_system_07,															
										$system_04_nombre,
	...
	{		
		...
		if ( $system_04_apellido =="" || $system_04_celular ==""  || $system_04_dni =="" )
		{
		...
		/*if ( $rela_system_07 == "3" )
		{
			if ( $system_03_mesa == "" )
			{
				return "Error: Elija mesa para el fiscal";
				exit;	
			}
		}*/
		...
		if ( $rela_system_07=="2" )// coordinador
		{
			$system_03_modo="1";
		}
		else
		if ( $rela_system_07=="3")// fiscal
		{
			$system_03_modo="2";
		}
		else
		if ( $rela_system_07=="4" )// operador
		{
			$system_03_modo="2";
		}
		else
		if ( $rela_system_07=="5" )// dirigente
		{
			$system_03_modo="2";
		}
		else						// observador
	...
	public function asignar_escuela($id_system_03,$system_03_mesa)
	{
		$respuesta = $this -> bd -> EnviarQuery("UPDATE system_03_usuarios SET 
		system_03_mesa = '$system_03_mesa'
		WHERE 
		id_system_03='$id_system_03'
		");
		if(!$respuesta!='Fatal')
	...
	public function reset_asignar_escuela($id_system_03)
	{
		$respuesta = $this -> bd -> EnviarQuery("UPDATE system_03_usuarios SET 
		system_03_mesa = '0'
		WHERE 
	...
	public function remover($id_system_09)
	{
		$respuesta = $this -> bd -> EnviarQuery("DELETE FROM system_09_archivero 
		WHERE 
