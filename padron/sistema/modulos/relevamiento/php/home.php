...
$t->set_file(array(
	'ver'			=> "home.html",
	'un_relevamiento'	=> "un_relevamiento.html",
...
// reset
$url6="'modulos/relevamiento/php/home.php'";
$id6="'content_seccion'";
$vars6="'reset_mesa=go'";
...
{	
	...
	{
		$url5="'modulos/relevamiento/php/home.php'";
		$id5="'content_seccion'";
...
// parte del paginador
	...
	if($row == true)
	{
		...
		{	
			...
			$url="'modulos/relevamiento/php/popup_canvas_perfil.php'";
			$id="'popup_canvas_left'";
			$vars="'id_system_01=$id_system_01&system_607_dni=$system_607_dni'";
			$t->set_var("funcion_pop_perfilado","cargar_post($url,$id,$vars)");	
			
			
			$t->parse("LISTADO","un_relevamiento",true);
		}
	} 
	else 						
	{	
