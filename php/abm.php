...
class Abm
{
											...
											)
	{
		...
		$system_09_fecha_hora = date('Y-m-d').' '.date('H:i:s');
	...
	public function guardar_nuevo_proyecto(	$sesion_system_03,
								$sesion_system_06,
								$system_460_checked,
								$mysqli										
								)
	{
		$system_460_tema = date('Y-m-d')." Nuevo proyecto...";
	
		$respuesta = $this -> bd -> EnviarQuery("INSERT INTO system_460_legislatura	
										(	
										rela_system_06,
										rela_system_03, 		
										system_460_tema,	
